...
- In CoinMP-1.8.4/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/coinmp-1.8.4 -DCMAKE_BUILD_TYPE=RELEASE ..'
...
An example:
```
$ wget https://www.coin-or.org/download/source/CoinMP/CoinMP-1.8.4.tgz
$ tar xvfz CoinMP-1.8.4.tgz
$ git clone https://github.com/ycollet/coinor-coinmp.git
$ cp -r coinor-coinmp/* CoinMP-1.8.4/
$ cd CoinMP-1.8.4
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/coinmp-1.8.4 -DCMAKE_BUILD_TYPE=RELEASE ..
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/coinmp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang -DCMAKE_CXX_FLAGS="-fsanitize=memory" ..
# or
$ cmake -DCMAKE_INSTALL_PREFIX=~/coinmp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang++ -DCMAKE_C_COMPILER=/usr/bin/clang \ 
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/coinmp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/opt/intel/bin/icpc -DCMAKE_C_COMPILER=/opt/intel/bin/icc ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=d:/coinmp-bin -DCMAKE_BUILD_TYPE=DEBUG -G "NMake Makefiles" ..
$ nmake
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/home/me/coinmp-bin -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_TOOLCHAIN_FILE=cmake/mingw64-toolchain.cmake ..
$ make
```
...
$ coinbrew/coinbrew fetch --git --main-proj="CoinMP"
$ cp -r ../coinor-coinmp/* CoinMP/
$ cd CoinMP
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/coinmp-devel -DCMAKE_BUILD_TYPE=RELEASE ..
...
$ git clone https://github.com/coin-or/CoinMP
$ cd CoinMP
